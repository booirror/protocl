...
import static com.uxuan.buffer.util.StringUtils.firstCharUpCase;
import static com.uxuan.buffer.util.StringUtils.nextLine;

import java.util.HashMap;
import java.util.Map;

import com.uxuan.buffer.AbstreactFieldType;
import com.uxuan.buffer.DefType;
